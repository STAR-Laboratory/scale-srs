...
require ( "./bench_common_baseline.pl");
...
print(STDERR "\t--w <workload/suite>   : workload suite from bench_common_baseline \n");
...
die "No benchmark set '$wsuite' defined in bench_common_baseline.pl\n"
    unless $SUITES{$wsuite};
@w = split(/\n/, $SUITES{$wsuite});
$num_w = scalar @w;


die "No benchmark set '$isuite' defined in bench_common_baseline.pl\n"
